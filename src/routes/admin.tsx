...
import { LayoutDashboard, ShoppingCart, History, LogOut, Users, Package, ChefHat } from "lucide-react";
...
function AdminHome() {
  ...
  const tiles = [
    ...
    { to: "/admin", label: "Produits", desc: "Bientôt disponible", icon: Package, color: "from-emerald-500/20 to-emerald-700/10" },
    { to: "/admin", label: "Personnel", desc: "Bientôt disponible", icon: Users, color: "from-purple-500/20 to-purple-700/10" },
    { to: "/admin", label: "Cuisine", desc: "Bientôt disponible", icon: ChefHat, color: "from-rose-500/20 to-rose-700/10" },
    { to: "/admin", label: "Analytics", desc: "Bientôt disponible", icon: LayoutDashboard, color: "from-cyan-500/20 to-cyan-700/10" },
  ];
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-background via-background to-muted/40">
      <header className="border-b border-border bg-card/60 backdrop-blur">
        <div className="mx-auto flex max-w-7xl items-center justify-between px-6 py-4">
          <div className="flex items-center gap-3">
            <img src={logo} alt="LEKKER" className="h-10 w-10 rounded-full object-cover" />
            <div>
          ...
          <div className="flex items-center gap-3">
            ...
            <Button variant="outline" size="sm" onClick={logout}><LogOut className="mr-2 h-4 w-4" />Déconnexion</Button>
          </div>
        </div>
      </header>
      ...
      <main className="mx-auto max-w-7xl px-6 py-8">
        ...
        <h2 className="mt-10 mb-4 font-serif text-2xl font-semibold">Modules</h2>
